...
const handleBubbleClick = (bubble, placedBubbles, containerWidth, containerHeight, overlapThreshold) => {
    ...
    bubble.style.backgroundImage = 'url("/INT3/assets/svg/background-bubble-after.svg")';
    ...
    const handleTransition = (e) => {
        ...
        bubble.style.transform = 'scale(0)';
        bubble.style.opacity = '0.5';
        bubble.style.backgroundImage = 'url("/INT3/assets/svg/background-bubble-before.svg")';
